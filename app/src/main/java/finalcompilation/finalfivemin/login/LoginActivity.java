package finalcompilation.finalfivemin.login;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyFromSQLite() {
        ...
        if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim()
            ...
            Intent nextIntent = new Intent(LoginActivity.this, ClinicsMain.class);
            nextIntent.putExtra(Constants.USER_ID_INTENT, returnUserID());
            emptyInputEditText();
    ...
    public int returnUserID(){
        return databaseHelper.keepUserID(textInputEditTextEmail.getText().toString().trim());
    }
}